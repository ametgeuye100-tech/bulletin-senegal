...
class Eleve(db.Model):
    ...
    date_naissance = db.Column(db.String(20), nullable=False) # AJOUTE
...
MATIERES = {
    ...
    "2nd S": ["PHILOSOPHIE","FRANÇAIS", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "ALLEMAND", "ITALIEN", "MATHS", "PC", "SVT", "EPS"],
    "2nd L": ["PHILOSOPHIE","FRANÇAIS", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "ALLEMAND", "ITALIEN", "MATHS", "PC", "SVT", "EPS"],
    "2nd G": ["PHILOSOPHIE","FRANÇAIS", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHS", "COMPTABILITE", "ECONOMIE", "DROIT", "ORGANISATION", "INFORMATIQUE", "EPS"],
    "2nd T": ["PHILOSOPHIE","FRANÇAIS", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHS", "PHYSIQUE", "CONSTRUCTION", "MECANIQUE", "ELECTRICITE", "DESSIN TECH", "EPS"],
    ...
    "1ère G": ["PHILOSOPHIE","FRANÇAIS", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHS", "COMPTABILITE", "ECONOMIE", "DROIT", "ORGANISATION", "INFORMATIQUE", "EPS"],
    "1ère T": ["PHILOSOPHIE","FRANÇAIS", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHS", "PHYSIQUE", "CONSTRUCTION", "MECANIQUE", "ELECTRICITE", "DESSIN TECH", "EPS"],
...
.btn-red{background:#dc3545;color:white;padding:5px 10px;text-decoration:none;border-radius:5px;font-size:12px;border:none;cursor:pointer;margin-left:5px}
...
<p>Classe: <b>{{eleve.classe}}</b> | Né(e) le: <b>{{eleve.date_naissance}}</b></p><hr><h3>Mes Bulletins</h3>
{% for b in bulletins %}
...
.mention-box{border:2px solid #00853F;padding:10px;width:45%;font-size:14px;font-weight:bold;text-align:center;background:#D4EDDA!important;color:#155724!important}
.app-box{border:2px solid #00853F;padding:10px;width:50%;background:#D4EDDA!important;color:#155724!important}
...
<div class="header">
<img src="https://flagcdn.com/w320/sn.png" class="drapeau-img"> <!-- SEUL DRAPEAU ICI -->
...
<div><b>Date de Naissance:</b> {{eleve.date_naissance}}</div><div><b>Année Scolaire:</b> {{bulletin.annee}}</div>
<div><b>IA:</b> {{bulletin.ia}}</div><div><b>IEF:</b> {{bulletin.ief}}</div>
<div><b>Etablissement:</b> {{bulletin.etablissement}}</div><div><b>Période:</b> {{bulletin.periode}}</div>
<div><b>Rang:</b> N/A</div>
</div>
...
def inscription():
    ...
    if not eleve:
        eleve = Eleve(telephone=tel, nom=request.form.get("nom"), prenom=request.form.get("prenom"), date_naissance=request.form.get("date_naissance"), classe=request.form.get("classe"))
...
if __name__ == "__main__":
   ...
   git add.
 git commit -m "Suppression 2eme drapeau + Date naissance"
 git push
