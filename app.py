...
# --- TOUTES LES DISCIPLINES PAR CLASSE ---
MATIERES = {
    ...
    "2nd S": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "ALLEMAND", "ITALIEN", "MATHS", "PC", "SVT", "EPS"],
    "2nd L": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "ALLEMAND", "ITALIEN", "MATHS", "PC", "SVT", "EPS"],
    "2nd G": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHS", "COMPTABILITE", "ECONOMIE", "DROIT", "ORGANISATION", "INFORMATIQUE", "EPS"],
    "2nd T": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHS", "PHYSIQUE", "CONSTRUCTION", "MECANIQUE", "ELECTRICITE", "DESSIN TECH", "EPS"],
...
.header{text-align:center;margin-bottom:10px}.drapeau-img{height:60px;vertical-align:middle;margin:0 15px}.titre{color:#00853F;font-weight:bold}
.info{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:15px 0;border-bottom:2px solid #000;padding-bottom:10px}
table{width:100%;border-collapse:collapse;margin-top:10px;table-layout:fixed} /* FIXE LARGEUR COLONNES */
th{background:#00853F;color:white}td,th{border:1px solid #000;padding:6px;text-align:center}
.col1{width:40%}.col2{width:10%}.col3{width:10%}.col4{width:15%}.col5{width:25%} /* LARGEUR COLONNES */
...
def voir_bulletin(id):
    ...
    notes_dispo = round(somme_coeff * 20, 2) # NOTES DISPONIBLES = SOMME COEF * 20
