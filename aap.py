...
# NOUVEAU BAREME SELON TA DEMANDE
...
/* COLORATION VERTE POUR MENTION ET APPRECIATION */
.mention-box{border:2px solid #00853F;padding:10px;width:45%;font-size:14px;font-weight:bold;text-align:center;background:#E8F5E9;color:#2E7D32}
.app-box{border:2px solid #00853F;padding:10px;width:50%;background:#E8F5E9;color:#2E7D32}
...
<div class="bas-page">
<div class="mention-box"> <!-- FOND VERT -->
MENTION: {{mention}}
</div>
<div class="app-box"> <!-- FOND VERT -->
