...
class Eleve(db.Model):
    ...
    date_naissance = db.Column(db.String(20), nullable=False) # NOUVEAU
...
<div><b>Date de Naissance:</b> {{eleve.date_naissance}}</div><div><b>Année Scolaire:</b> {{bulletin.annee}}</div> <!-- NOUVEAU -->
...
def inscription():
    ...
    if not eleve:
        eleve = Eleve(
            ...
            date_naissance=request.form.get("date_naissance"), # NOUVEAU
