...
<button onclick="confirmerSuppression({{b.id}})" class="btn-red">🗑️ SUPPRIMER</button> <!-- BOUTON AJOUTE -->
</div>
...
/* COLORATION VERTE */
.mention-box{border:2px solid #00853F;padding:10px;width:45%;font-size:14px;font-weight:bold;text-align:center;background:#D4EDDA;color:#155724}
.app-box{border:2px solid #00853F;padding:10px;width:50%;background:#D4EDDA;color:#155724}
...
<div class="bas-page">
<div class="mention-box"> <!-- VERT -->
MENTION: {{mention}}
</div>
<div class="app-box"> <!-- VERT -->
...
@app.route("/supprimer/<int:id>") # ROUTE AJOUTEE
