...
# TOUTES LES MATIERES POUR TOUTES LES CLASSES - CORRIGÉ
MATIERES = {
    "6e": ["FRANÇAIS", "MATHEMATIQUES", "PC", "SVT", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "EDUCATION CIVIQUE", "EDUCATION PHYSIQUE", "DESSIN"],
    "5e": ["FRANÇAIS", "MATHEMATIQUES", "PC", "SVT", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "EDUCATION CIVIQUE", "EDUCATION PHYSIQUE", "DESSIN"],
    "4e": ["FRANÇAIS", "MATHEMATIQUES", "PC", "SVT", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "EDUCATION CIVIQUE", "EDUCATION PHYSIQUE", "DESSIN", "MUSIQUE"],
    "3e": ["FRANÇAIS", "MATHEMATIQUES", "PC", "SVT", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "EDUCATION CIVIQUE", "EDUCATION PHYSIQUE", "DESSIN", "MUSIQUE"],
    "2nd S": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "MATHEMATIQUES", "PC", "SVT", "EDUCATION PHYSIQUE"],
    "2nd L": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "MATHEMATIQUES", "PC", "SVT", "EDUCATION PHYSIQUE"],
    "1ère S": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "MATHEMATIQUES", "PC", "SVT", "EDUCATION PHYSIQUE"],
    "1ère L": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "MATHEMATIQUES", "ECONOMIE", "PC", "SVT", "EDUCATION PHYSIQUE"],
    "Terminale S": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "MATHEMATIQUES", "PC", "SVT", "EDUCATION PHYSIQUE"],
    "Terminale L": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "ARABE", "MATHEMATIQUES", "ECONOMIE", "PC", "SVT", "EDUCATION PHYSIQUE"],
    "2nd G": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHEMATIQUES", "COMPTABILITE", "ECONOMIE", "DROIT", "ORGANISATION", "INFORMATIQUE", "EDUCATION PHYSIQUE"],
    "1ère G": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHEMATIQUES", "COMPTABILITE", "ECONOMIE", "DROIT", "ORGANISATION", "INFORMATIQUE", "EDUCATION PHYSIQUE"],
    "Terminale G": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHEMATIQUES", "COMPTABILITE", "ECONOMIE", "DROIT", "ORGANISATION", "MARKETING", "INFORMATIQUE", "EDUCATION PHYSIQUE"],
    "2nd T": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHEMATIQUES", "PHYSIQUE", "CONSTRUCTION", "MECANIQUE", "ELECTRICITE", "DESSIN TECHNIQUE", "EDUCATION PHYSIQUE"],
    "1ère T": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHEMATIQUES", "PHYSIQUE", "CONSTRUCTION", "MECANIQUE", "ELECTRICITE", "DESSIN TECHNIQUE", "EDUCATION PHYSIQUE"],
    "Terminale T": ["FRANÇAIS", "PHILOSOPHIE", "HISTOIRE/GEOGRAPHIE", "ANGLAIS", "ESPAGNOL", "MATHEMATIQUES", "PHYSIQUE", "CONSTRUCTION", "MECANIQUE", "ELECTRICITE", "DESSIN TECHNIQUE", "TECHNOLOGIE", "EDUCATION PHYSIQUE"]
}

def get_appreciation_matiere(moy):
    if moy >= 18: return "Excellent"
    elif moy >= 16: return "Très Bien"
...
def get_appreciation_generale(moy, classe):
    if moy >= 18: return "Excellent. Félicitations du Conseil de Classe. Tableau d'Honneur."
    elif moy >= 16: return "Très Bien. Encouragements du Conseil de Classe."
    elif moy >= 14: return "Bien. Peut mieux faire."
    elif moy >= 12: return "Assez Bien. Des efforts sont nécessaires."
    elif moy >= 10: return "Passable. Doit travailler davantage."
    else: return "Insuffisant. Risque de redoublement."
...
selects.forEach(s=>{s.innerHTML='<option>--Choisir--</option>';if(matieres[classe]){matieres[classe].forEach(m=>{let o=document.createElement('option');o.value=m;o.text=m;s.appendChild(o);})}}else{s.innerHTML='<option>Aucune matière</option>'})}
...
let app=''; if(moy>=18)app='Excellent';else if(moy>=16)app='Très Bien';else if(moy>=14)app='Bien';
else if(moy>=12)app='Assez Bien';else if(moy>=10)app='Passable';else app='Insuffisant';
...
.header{text-align:center;margin-bottom:10px}.drapeau-img{height:80px;margin-bottom:10px}.titre{color:#00853F;font-weight:bold}
...
.total-box{display:grid;grid-template-columns:1fr 1fr 1fr 1fr 1fr;gap:10px;margin-top:15px;padding:10px;border:2px solid #E31B23;background:#FFE5E5;font-weight:bold;text-align:center;color:#B91C1C}
.moyenne{font-size:22px;color:#E31B23}
.bas-page{display:flex;justify-content:space-between;margin-top:20px}
.mention-box{border:2px solid #E31B23;padding:10px;width:45%;font-size:14px;font-weight:bold;text-align:center;background:#FFE5E5;color:#B91C1C}
.app-box{border:2px solid #E31B23;padding:10px;width:50%;background:#FFE5E5}
...
{% endfor %}</table>
<div class="total-box">
<div>TOTAL COEF<br>{{somme_coeff}}</div>
<div>TOTAL DES POINTS<br>{{somme_notes}}</div>
<div>POINTS DISPONIBLES<br>{{notes_dispo}}</div>
...
<div class="app-box"><b>APPRECIATION GENERALE:</b><br> {{bulletin.appreciation}}</div>
</div>
<div class="footer">
